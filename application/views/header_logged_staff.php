...
<div id="id01" class="modal">
    ...
    <form id="reportform" action= "<?=base_url()?>Report/addreport" method="post" class="modal-content">
...
<!-- Navigation Section ---> 
    <header class="header-section">
        <nav>
            ...
            <div>               
                <ul class="main-menu">
                    <li><a href="<?=base_url()?>Welcome_Admin">Home</a></li>
                    <li><a href="<?=base_url()?>Report_Admin">Report</a></li>
                    <li><a href="<?=base_url()?>Info">Information</a></li>
                    <li><a href="<?=base_url()?>Volunteer_Admin">Volunteer</a></li>
                    <li><a href="<?=base_url()?>Welcome">Logout</a></li>
                </ul>
            </div>  
        </nav>
    </header>